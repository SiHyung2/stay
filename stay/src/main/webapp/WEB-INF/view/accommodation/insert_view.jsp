...
<!--                     뷰에서 input만 바뀌면 됨 -->
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="accommodation_checkin" name="checkin" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="accommodation_checkout" class="form-label">체크아웃</label>
                        <input type="date" class="form-control" id="accommodation_address" name="checkout" required>
                    </div>
